...
<a target='_blank' href='http://docs.oasis-open.org/odata/odata/v4.01/cs01/part1-protocol/odata-v4.01-cs01-part1-protocol.html#sec_SystemQueryOptioncount'>Count</a>";
    ...
    private static readonly OpenApiParameter _countParameter = CreateODataParameter("boolean", "$count", "OData: Field that allow to set if you want the total count", "false");
    private static readonly OpenApiParameter[] _oDataParameters = { _filterParameter, _countParameter, _orderByParameter, _skipParameter, _topParameter };
    ...
    public void Apply(OpenApiOperation operation, OperationFilterContext context)
    {
        ...
        if (operation.Parameters == null)
            ...
            foreach (var p in _oDataParameters)
